...
local leader_mappings = {
  ...
  s = {
    name = "System",
    m = { ":call ToggleMouse()<cr>", "Toggle Mouse" }, -- theme=ivy
    w = { ":call ToggleWrap()<cr>", "Toggle Wrap" }, -- theme=ivy
    h = { "<cmd>AerialToggle!<CR>", "Aerial Toggle" },
    u = { "<cmd>UndotreeToggle<CR>", "Undo Logs" },
...
local leader_vmappings = {
  ...
  ["l"] = { ":TranslateR --target_lang=vi --engines=google<cr>", "Translate" }
